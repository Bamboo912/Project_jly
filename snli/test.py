...
# File paths
tf.flags.DEFINE_string('test_data_file', 'E:\\Lessons\\MachineLearning\\Project\\TextClassification-master\\data\\data.csv', 'Test data file path')
tf.flags.DEFINE_string('run_dir', 'E:\\Lessons\\MachineLearning\\Project\\TextClassification-master\\runs\\1618658416', 'Restore the model from this run')
tf.flags.DEFINE_string('checkpoint', 'clf-14000', 'Restore the graph from this checkpoint')
